                ...
                <div class="col-12">
                    <div class="copy-right-content-area">
                        ...
                        <ul>
                            ...
                            <li>
                                <p class="store-policy-para">Defective image/artwork (does not match the fulfillment information, and/or image is printed with defects).</p>
                            </li>
                            <li>
                                <p class="store-policy-para">Product construction issues (missing parts, torn material, broken and/or missing components and/or sewing/stitching errors).</p>
                            </li>
                            <li>
                                <p class="store-policy-para">The product does not match the fulfillment information or has defects (e.g., printed images are incorrect or placed incorrectly, the product is the wrong size, color, or type, stains, sewing or stitching errors, broken or missing components, etc.).</p>
                            </li>
                        </ul>
                        
                        <div class="abc">
                            <h3 class="store-policy-para fnt-weight-bold-700 mb-5px">Return/Refund Eligibility</h3>
                        ...
                        <div class="abc">
                            <h3 class="store-policy-para fnt-weight-bold-700 mb-5px">How to Initiate a Return or Refund:</h3>
                            <button type="button" class="open-section mb-10px">(Click to read section)</button>
                            ...
                            <div class="click-section">
                                ...
                                <p class="store-policy-para"><span class="fnt-weight-bold-600">Note:</span>If the issue is based on a size discrepancy, the tag where the item size is located must be clearly shown.  These supporting image(s) MUST be included in your email return/refund request, or your request won’t be considered until the picture(s) are received by us.</p>
                                
                                <h4 class="store-policy-para fnt-weight-bold-600">Step 2:</h4>
                                
                                <p class="store-policy-para">If your Return and/or Refund request is accepted by us, you will be notified via email and you will be emailed an electronic “Store Gift Card” with a special “Gift Card Code” to be used in your new replacement/purchase.  <span class="fnt-weight-bold-600">Please take note:</span>  Some refunds will have a gift card expiration date, so please take note of the details on your gift card.  For products being returned to us, we will email you a shipping label with instructions on how to ship the item back to us.  This process may take up to 5 business days.</p>
                                
                                <h4 class="store-policy-para fnt-weight-bold-600">Step 3:</h4>
                                
                                <p class="store-policy-para"><span class="fnt-weight-bold-600">Shipping an Item Back to Us:</span>Use the return shipping label that we sent to you and affix it as instructed to the original shipping box or package you received it in, or in a substitute container of same or superior durability and size.</p>
                                
                                <p class="store-policy-para">Your “returned” item must be in the same condition that you received it, unworn or unused, with tags, and in its original “in-box” packaging.  You’ll also need a copy of the receipt or proof of purchase included in the return container.  Items sent back to us without first requesting a return/refund authorization and being approved by us will not be accepted.  You can always contact us for any return questions prior to returning an item at: <span class="fnt-weight-bold-600">service@rjcreative.shop.</span></p>
                            </div>
                        </div>
                        
                        <div class="abc">
                            <h4 class="store-policy-para fnt-weight-bold-700 mb-5px">Refunds:</h4>
                            <button type="button" class="open-section mb-10px">(Click to read section)</button>
                        ...
                        <div class="abc">
                            <h4 class="store-policy-para fnt-weight-bold-700  mb-5px">Damages and issues:</h4>
                            <button type="button" class="open-section mb-10px">(Click to read section)</button>

                            <div class="click-section">
                                <p class="store-policy-para">Please inspect your order upon reception and contact us immediately if the item is defective, damaged or if you received the wrong item so that we can evaluate the issue and accommodate accordingly. <span class="fnt-weight-bold-600">ALL refund claims MUST be submitted via email to us within 30 days of receiving your product.</span></p>
                            </div>
                        </div>

                        <div class="abc">
                            <h4 class="store-policy-para fnt-weight-bold-700 mb-5px">Exceptions / Non-returnable Items</h4>
                            <button type="button" class="open-section mb-10px">(Click to read section)</button>

                        
                            <div class="click-section">
                                <p class="store-policy-para"><span class="fnt-weight-bold-600">Certain types of items cannot be returned.</span>Unfortunately, we cannot accept returns/refunds on “purchased” gift cards or for items damaged during the shipping process (some exceptions may apply at our sole discretion).</p>

                                <p class="store-policy-para"><span class="fnt-weight-bold-600">Note:</span>For damages caused during the shipping process while being under the control of the shipping company:  All damage claims should be directed to the shipping company for compensation and resolution.</p>
                        ...
                        <div class="abc">
                            <h4 class="store-policy-para fnt-weight-bold-700 mb-5px">Exchanges:</h4>
                            <button type="button" class="open-section mb-10px">(Click to read section)</button>
                        ...
                        <div class="abc">
                            <h4 class="store-policy-para fnt-weight-bold-700 mb-5px">All Sales Are Final:</h4>
                            <button type="button" class="open-section mb-10px">(Click to read section)</button>
                        ...
                        <p class="store-policy-small-para">RJ Creative (<a href="#">www.rjcreative.shop</a>) Return/Refund Policy V1</p>
